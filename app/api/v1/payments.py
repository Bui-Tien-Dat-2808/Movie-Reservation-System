    ...
    return [
        {
            ...
            "bank_code": "CASH" if tx.payment_method == "cash" else (tx.bank_code or "VNPay"),
            "card_type": "CASH" if tx.payment_method == "cash" else (tx.card_type or ""),
            "transaction_no": tx.transaction_no or ("CASH" if tx.payment_method == "cash" else ""),
            "vnp_txn_ref": tx.vnp_txn_ref,
            "status": "success" if tx.payment_method == "cash" else tx.status,
